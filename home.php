...
<head>
    ...
    <h1>Welcome to Explicit knowledge management system</h1>
 <!-- animation -->
...
<!-- ===== End Slider ===== -->
    ...
    <img src="img1.jpg" alt="knowledge image">  
    
<img src="img2.jpg" alt="Computer Man" style="width:400px;height:400px;" > 
<style>
    body {
      background-image: /url("http://localhost//kms/images/logo.gif");
    }
    </style> 
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="info">
                        ...
                        <p>harriet.arimi@gmail.com <br> harriet.arimi@gmail.com</p>
